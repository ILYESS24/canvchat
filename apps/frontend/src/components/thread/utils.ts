...
export function getUserFriendlyToolName(name: string) {
  return name;
}

export function extractAppSlugFromToolCall(toolCall: any) {
  return toolCall?.function?.name || '';
}

// Temporary constants (normally from @agentpress/shared)
export const HIDE_STREAMING_XML_TAGS = ['<thinking>', '</thinking>'];
