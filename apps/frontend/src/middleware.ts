...
export async function middleware(request: NextRequest) {
  ...
  const supabaseKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'demo_anon_key_for_local_development';

  console.log('Using SUPABASE_URL:', supabaseUrl);
  console.log('Using SUPABASE_KEY:', supabaseKey.substring(0, 10) + '...');
