...
// Temporary functions (normally from @agentpress/shared)
function getUserFriendlyToolName(name: string) { return name; }
function isHiddenTool() { return false; }
function normalizeArrayValue() { return []; }
function normalizeAttachments() { return []; }
