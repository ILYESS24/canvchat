...
# Mock openai - not available in deployment
logger.warning("openai not available, using mock implementation for deployment compatibility")

class MockAsyncOpenAI:
    def __init__(self, api_key: str):
        self.api_key = api_key
        logger.warning("Mocking OpenAI AsyncOpenAI client. AI services not available.")

    class MockChat:
        class MockCompletions:
            async def create(self, **kwargs):
                logger.info("Mocking OpenAI chat.completions.create")
                return type('MockResponse', (), {
                    'choices': [type('Choice', (), {
                        'message': type('Message', (), {
                            'content': 'Mock AI translation: This is a placeholder response since AI services are not configured.'
                        })()
                    })()]
                })()
...
# Replace openai import with mock
openai = type('module', (), {'AsyncOpenAI': MockAsyncOpenAI})()
