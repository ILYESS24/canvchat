...
class MockOpenAI:
    def __init__(self, api_key: str):
        ...
        logger.warning("Mocking OpenAI client. AI services not available.")

    class MockAudio:
        class MockTranscriptions:
            def create(self, **kwargs):
                logger.info("Mocking OpenAI audio.transcriptions.create")
                return type('MockResponse', (), {'text': 'Mock transcription: This is a placeholder since AI services are not configured.'})()
...
openai = MockOpenAI(api_key='mock')
