...
from core.mcp_module.mcp_mocks import ClientSession, StdioServerParameters
...
class MCPRegistry:
    ...
    async def _load_sse_mcp_schemas(self, config: Dict[str, Any]) -> Dict[str, Dict[str, Any]]:
        ...
        # MCP imports replaced with mocks
    ...
    async def _load_json_mcp_schemas(self, config: Dict[str, Any]) -> Dict[str, Dict[str, Any]]:
        ...
        # MCP imports replaced with mocks, StdioServerParameters
